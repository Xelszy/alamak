...
func (h *BookHandler) create(c *gin.Context) {
	...
	repo := req.ToRepo()          // Convert BookCreateReq to BookRepo
	err := h.service.Create(repo) // Pass BookRepo to Create method
	if err != nil {
...
//	@Produce json
//	@Param q query string false "Book title"
...
func (h *BookHandler) delete(c *gin.Context) {
	...
	c.JSON(http.StatusOK, dto.SuccessResponse[any]{
		Success: true,
		Message: "Book data successfully deleted",
	})
}
